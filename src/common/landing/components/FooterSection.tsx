      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          >
            ...
            >
              AyurSutra is a smart Panchakarma management platform designed to
              simplify operations, enhance patient care and promote holistic
              wellness.
            </p>
            {/* Social icons */}
          ...
          >
            ...
            {[
              ...
              {
                icon: <Mail size={14} />,
                text: "support@ayusutra.com",
                href: "mailto:support@ayusutra.com",
              },
              {
                icon: <MapPin size={14} />,
                text: "123 Ayurveda Street, Wellness City, India – 100001",
                href: undefined,
              },
            ].map((item, i) => (
              <div
