          ...
          >
            ...
            <div>
              ...
              <input
                ...
                disabled={isLoading}
                className={`w-full px-4 py-3 rounded-xl border text-[14px] text-[#111111] bg-[#FEFDF9] focus:outline-none transition-colors ${errors.email
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  disabled={isLoading}
                  className={`w-full px-4 py-3 pr-12 rounded-xl border text-[14px] text-[#111111] bg-[#FEFDF9] focus:outline-none transition-colors ${errors.password
                      ? "border-red-400 focus:border-red-400"
                      : "border-[#E1E4DA] focus:border-[#15803d] focus:ring-1 focus:ring-[#15803d]/30"
                    }`}
                />
